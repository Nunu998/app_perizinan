...
if ($_FILES['logo']['name'] == '') {
    $sql = mysqli_query($db, "UPDATE tb_instansi SET nama='$nama', institusi='$institusi', status='$status', alamat='$alamat', kepala='$kepala', nip='$nip', email='$email', notelp='$notelp', logo='$logolama' WHERE id_instansi = '1'");
