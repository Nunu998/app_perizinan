...
(function () {
  ...
  (b = window.Morris = {}),
        ...
        'static' === this.el.css('position') && this.el.css('position', 'relative'),
          ...
          this.el.bind('mousemove', function (a) {
            ...
            return (
              (d = c.el.offset()),
              (g = a.pageX - d.left),
              c.selectFrom ? ((b = c.data[c.hitTest(Math.min(g, c.selectFrom))]._x), (e = c.data[c.hitTest(Math.max(g, c.selectFrom))]._x), (f = e - b), c.selectionRect.attr({ x: b, width: f })) : c.fire('hovermove', g, a.pageY - d.top)
            );
          }),
      ...
      return (
          ...
          for (k = '', c && (g = b.Line.gradients(a)), l = { y: null }, h = q = 0, r = a.length; r > q; h = ++q)
            (e = a[h]),
              null != e.y &&
                (null != l.y
                  ? c
                    ? ((f = g[h]), (j = g[h - 1]), (i = (e.x - l.x) / 4), (m = l.x + i), (o = Math.min(d, l.y + i * j)), (n = e.x - i), (p = Math.min(d, e.y - i * f)), (k += 'C' + m + ',' + o + ',' + n + ',' + p + ',' + e.x + ',' + e.y))
                    : (k += 'L' + e.x + ',' + e.y)
        ...
        (c.gradients = function (a) {
          ...
          for (
            ...
            (b = a[d]),
              null != b.y ? ((e = a[d + 1] || { y: null }), (f = a[d - 1] || { y: null }), null != f.y && null != e.y ? i.push(c(f, e)) : null != f.y ? i.push(c(f, b)) : null != e.y ? i.push(c(b, e)) : i.push(null)) : i.push(null);
          return i;
        }),
    ...
    (b.Donut = (function (c) {
      ...
      return (
        h(d, c),
        (d.prototype.defaults = { colors: ['#0B62A4', '#3980B5', '#679DC6', '#95BBD7', '#B0CCE1', '#095791', '#095085', '#083E67', '#052C48', '#042135'], backgroundColor: '#FFFFFF', labelColor: '#000000', formatter: b.commas, resize: !1 }),
        (d.prototype.redraw = function () {
