...
if ($_GET['act'] == 'tambah') {
    ...
    if ($nale != "" || $nosu != "" || $tg != "" || $per != "" || $al != "" || $nape != "" || $nip != "" || $nk != "" || $kk != "" || $bd != "" || $au != "" || $ds != "" || $kec != "" || $kab != "" || $prov != "" ) {
        ...
        if ($cek_nomor) {
            ...
            if ($_FILES['fileth']['name'] == '') {
                $insert = mysqli_query($db, "INSERT INTO tb_telahaan VALUES (NULL, '$nale', '$nosu', '$tg', '$per', '$al', '$nape', '$nip','$nk','$kk','$bd','$au','$ds','$kec','$kab','$prov','TIDAK ADA FILE', '-Mohon Tunggu Ya, Admin Akan Memberikan Keterangan-', 'Menunggu')");
                if ($insert) {
                ...
                if (!in_array($ext, $ekstensi)) {
                    ...
                    if ($ukuran < 5044070) { //5Mb		
                        ...
                        $insert = mysqli_query($db, "INSERT INTO tb_telahaan VALUES (NULL, '$nale', '$nosu', '$tg', '$per', '$al', '$nape', '$nip','$nk','$kk','$bd','$au','$ds','$kec','$kab','$prov',  '$xx', '-Mohon Tunggu Ya, Admin Akan Memberikan Keterangan-', 'Menunggu')");
                        if ($insert) {
                            $_SESSION['info'] = 'Disimpan';
                            echo "<script>document.location.href='../pengajuan.php'</script>";
                        } else {
