                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php
                                    $sql = mysqli_query($db, "SELECT * FROM tb_telahaan WHERE konfirmasi='Menunggu'");
                                    $no = 1;
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <a title="Detail" href="detail_th.php?id=<?= $row['id_telahaan'] ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>

                                                    <!-- <a title="Disposisi" href="disposisi.php?id=<?= $row['id_telahaan'] ?>" class="btn btn-info btn-sm"><i class="fa fa-archive"></i></a> -->

                                                    <a title="Edit" href="" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#edit<?php echo $row['id_telahaan']; ?>"><i class="fa fa-edit"></i></a>
                                                            ...
                                                            ?>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label class="font-weight-bold">Konfirmasi</label>
                                                                            <select name="kon" class="form-control" required>
